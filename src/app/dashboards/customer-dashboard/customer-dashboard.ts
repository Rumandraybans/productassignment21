...
export class CustomerDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Wrapping your data initialization in a macro-task queue tick ensures the browser's 
    // network client and AuthInterceptor have access to the newly minted token payload strings.
    setTimeout(() => {
